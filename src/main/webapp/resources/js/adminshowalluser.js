...
function firstPage(){  
    if(currentPage == 1){  
        ...
        submitForm("/springboot/adminshowalluser?pageNum=1");
        return true;  
    }  
}  
...
function nextPage(){  
	if(currentPage == totalPage){  
        ...
        submitForm("/springboot/adminshowalluser?pageNum=" + (currentPage+1));
        return true;  
    }  
}  
...
function lastPage(){  
    if(currentPage == totalPage){  
        ...
        submitForm("/springboot/adminshowalluser?pageNum="+totalPage);
        return true;  
    }  
}
