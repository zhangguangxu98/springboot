...
function firstPage(){  
    if(currentPage == 1){  
        ...
        submitForm("/springboot/adminshowallmyplan?pageNum=1"+"&pageSize=10");
        return true;  
    }  
}  
...
function nextPage(){  
	if(currentPage == totalPage){  
        ...
        submitForm("/springboot/adminshowallmyplan?pageNum=" + (currentPage+1)+"&pageSize=10");
        return true;  
    }  
}  
...
function lastPage(){  
    if(currentPage == totalPage){  
        ...
        submitForm("/springboot/adminshowallmyplan?pageNum="+totalPage+"&pageSize=10");
        return true;  
    }  
}
