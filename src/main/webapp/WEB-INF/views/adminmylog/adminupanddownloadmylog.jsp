...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="../springboot/resources/css/adminupanddownloadmylog.css">
                    ...
                    <tr>
                         ...
                         <td  class="exceltest">
                             <div class="exceltest1">
                                  <form action="adminuploadmylog" method="post" name="uploadform" enctype="multipart/form-data">
                                  <table id="exceltest3">
                                         <tr>
                                              <td class="exceltest4">
                                                  	上传日志:
                                  ...
                                  <table id=exceltest5> 
                                         <tr>
                                             ...
                                             <td>
                                             	 <input type=button value="下载模板" onclick="window.location.href='/springboot/adminuploadlogtemplate'">
                                             </td>
                                             <td>
                                  ...
                                  <form action="admindownloadmylog" method="post">
                                  <table id="exceltest6">
                                         <tr>
                                              <td class="exceltest7">
                                                  	下载日志:
