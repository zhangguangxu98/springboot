...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="../springboot/resources/css/adminupanddownloadlotteryresult.css">
	...
	<script type="text/javascript">
	    ...
	    function downTemplate(){
	        window.location.href="/springboot/adminuploadlotterytemplate";
	    }
	</script>
  </head>
                    ...
                    <tr>
                         ...
                         <td  class="exceltest">
                             <div class="exceltest1">
                                  <form action="adminuploadlotteryresult" method="post" name="uploadform" enctype="multipart/form-data">
                                  <table id="exceltest3">
                                         <tr>
                                              <td class="exceltest4">
                                                  	上传彩票结果:
                                  ...
                                  <table id=exceltest5> 
                                     ...
                                     <hr width=100% size=3 color=#5151A2 style="">
                                     <form action="admindownloadlotteryresult" method="post">
                                  <table id="exceltest6">
                                         <tr>
                                              <td class="exceltest7">
                                                  	下载彩票结果:
